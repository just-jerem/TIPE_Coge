...
# ================================
# Paramètres pour diagrammes P-V et T-S
# ================================
st.sidebar.markdown("### Paramètres pour diagrammes P-V et T-S")
...
# ================================
# Tableau des bilans énergétiques
# ================================
...
# ================================
# Paramètres pour étude paramétrique
# ================================
st.markdown("---")
            ...
            for Tmax in Tmax_values:
                for Pmin in Pmin_values:
                    for Pmax in Pmax_values:
                        ...
                        chart_placeholder.line_chart(df["Rendement (%)"])
                        k += 1
